...
void CL_InitLocal( void )
{
	...
	cl_draw_particles = Cvar_Get( "r_drawparticles", "0.8", FCVAR_CHEAT, "render particles" );
	...
	Cvar_Get( "hud_scale", "1", FCVAR_ARCHIVE|FCVAR_VIDRESTART, "scale hud at current resolution" );
